...
terraform {
  source = "git::git@github.com:plus3it/terraform-aws-tardigrade-transit-gateway//modules/peering-attachment"
}

inputs = {
  peer_transit_gateway_id = dependency.us_west_tgw.outputs.ec2_transit_gateway_id
  transit_gateway_id      = dependency.us_east_tgw.outputs.ec2_transit_gateway_id
